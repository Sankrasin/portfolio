      ...
      <main className="relative pt-32 pb-20 px-8 max-w-6xl mx-auto flex flex-col gap-40 overflow-hidden">
        ...
        <section className="min-h-[70vh] flex flex-col justify-center">
          ...
          >
             ...
             <a href="/resume.pdf" download="Sankalp_Raj_Singh_Resume.pdf" className="inline-block px-8 py-4 bg-transparent text-white font-body tracking-widest uppercase font-bold hover:bg-white/10 transition-all rounded-3xl border border-white/20 backdrop-blur-md">
                RESUMÉ ⬇
             </a>
